...
<script
	src="${pageContext.request.contextPath }/resources/js/stomp.min.js"></script>
	...
	<script>
            ...
            $(document).ready(function(){
                ...
                stomp.connect({}, function (){
                   ...
                   stomp.send('/pub/enter', {}, JSON.stringify({room_id: room_id, chat_writer: username}))
                ...
                $("#button-send").on("click", function(e){
                    ...
                    stomp.send('/pub/message', {}, JSON.stringify({room_id: room_id, chat_content: msg.value, chat_writer: username}));
                    msg.value = '';
                    myLoad = true;
                });

package com.test.chat.stompController;
...
//	
    ...
    public ModelAndView rooms(HttpServletRequest request){
        ...
        mv = new ModelAndView("/chat/rooms");
	...
	@GetMapping("room")
	public void getRoom(@RequestParam(defaultValue = "-1") String room_id, Model model ){
		if(!room_id.equals("-1")) {
			model.addAttribute("room", chatService.getChatRoom(Integer.parseInt(room_id)));
			model.addAttribute("chatList", chatService.getChatList(Integer.parseInt(room_id)));
